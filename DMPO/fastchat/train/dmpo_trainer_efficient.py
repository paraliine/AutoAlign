...
if is_deepspeed_available() and torch.cuda.is_available():
    import deepspeed
...
class DPOMultiTrainer(Trainer):
    ...
    def get_batch_samples(self, model, batch: Dict[str, torch.LongTensor], *args, **kwargs) -> Tuple[str, str]:
        if not isinstance(batch, dict):
            return super().get_batch_samples(model, batch, *args, **kwargs)
